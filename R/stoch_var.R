...
#'\code{stoch_var} calculates the intrinsic stochastic invariability a theoretical equivalent of the univariate measure of invariability (Arnoldi, Loreau, and Haegeman 2016).
#'
