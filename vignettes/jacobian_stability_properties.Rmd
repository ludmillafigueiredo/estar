...
![Figure 2: The $B$ matrix that the `estar` Jacobian functions take in as argument is the $m \times m$ Jacobian community matrix (for $m$ species). Each entry reflects the effect of the population abundance of the species in the column on the population growth rate of the species in the row](figures/B_matrix.png)
