...
- U = A = 0
* No processes error and constant covariates are required for @downing_temporal_2020's calculations of asymptotic resilience
...
## Processes have the same variance and the same covariance
In this case, $Q = \text{"equalvarcov"}$ in the MARSS function or 
\begin{equation}
Q = 
\begin{bmatrix}
...
## Processes have the same variance and no covariances
In this case, $Q = \text{"diagonal and equal"}$.
...
## Single process covariate effect for all groups ?

## Single observation covariate for all groups ?
