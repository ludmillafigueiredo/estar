...
# Performance of multivariate metrics

We conducted the benchmark analysis of the execution time of the different multivariate metrics. The code used for the analysis is available in `performance_analysis.R`.
...
![Density distribution of execution times of 100 runs of each of the different functions used to calculate multivariate metrics, as demonstrated in this vignette.](figures/multivar_benchmark.png){width=100%}
